...
Writes: data/musdb16k/<track>/{vocals.wav,accomp.wav}
"""
import io
import zipfile
...
for i, tr in enumerate(tracks, 1):
    ...
    sf.write(d / "vocals.wav", voc[:n].numpy(), SR, subtype="PCM_16")
    sf.write(d / "accomp.wav", acc[:n].numpy(), SR, subtype="PCM_16")
